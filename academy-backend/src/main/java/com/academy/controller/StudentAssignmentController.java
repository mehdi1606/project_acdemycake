...
public class StudentAssignmentController {
    ...
    @Operation(summary = "Get published assignments for one enrolled course")
    public ResponseEntity<ApiResponse<List<AssignmentResponse>>> getAssignmentsForCourse(
    ...
    public ResponseEntity<ApiResponse<String>> uploadSubmissionFile(@RequestParam("file") MultipartFile file) {
        return ResponseEntity.ok(ApiResponse.success("File uploaded", assignmentService.uploadSubmissionFile(file)));
    }
