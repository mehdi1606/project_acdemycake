                ...
                <tbody>
                  {certificates.map((cert, idx) => (
                    <tr key={cert.id}>
                      ...
                      <td>
                        <button type="button" onClick={() => setSelected(cert)} style={{
                          background: 'none', border: 'none', padding: 0, cursor: 'pointer',
                          fontWeight: 600, color: 'var(--lx-primary)', fontSize: 13.5, textAlign: 'left',
                        }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  ...
                  <h5 style={{ fontWeight: 700, color: '#4B121C', margin: 0, fontSize: 16 }}>
              ...
              {/* Certificate visual — landscape layout matching the PDF */}
              <div style={{ display: 'flex', minHeight: 280 }}>
                ...
                <div style={{
                  ...
                  <div style={{ position: 'relative', textAlign: 'center', paddingTop: 8 }}>
                    ...
                    <div style={{
                      height: 1.5,
                      background: 'linear-gradient(90deg, transparent, #C5973E, transparent)',
                  ...
                  <div style={{
                    ...
                    {[
                      ...
                      <div key={i} style={{ textAlign: 'center', minWidth: 120 }}>
                        ...
                        <p style={{ fontSize: 9, color: '#9e7a7a', letterSpacing: 1, margin: 0 }}>
                  ...
                  <p style={{
                    ...
                    Certificate No:&nbsp;
                    <strong style={{ color: '#6B1D2A' }}>{selected.certificateNumber}</strong>
                  </p>
                </div>
              </div>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
                  <div>
                    <p style={{ fontSize: 10, color: '#9e7a7a', margin: 0, textTransform: 'uppercase', letterSpacing: 1 }}>Course</p>
                    <p style={{ fontSize: 13, fontWeight: 600, color: '#4B121C', margin: 0 }}>{selected.courseTitle}</p>
                  </div>
                  <div>
                    <p style={{ fontSize: 10, color: '#9e7a7a', margin: 0, textTransform: 'uppercase', letterSpacing: 1 }}>Instructor</p>
                    <p style={{ fontSize: 13, fontWeight: 600, color: '#4B121C', margin: 0 }}>{selected.instructorName ?? '—'}</p>
                  </div>
                </div>
